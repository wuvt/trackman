...
from trackman import auth_manager, db, format_datetime  # noqa: F401
...
def letter(letter, page=1):
    ...
    return render_template('library/letter.html', letter=letter,
                           artists=artists)
...
def djs(page=1):
    ...
    return render_template('library/djs.html', djs=djs)
...
def dj(id, page=1):
    ...
    return render_template('library/dj.html', dj=dj, tracks=tracks)
...
def label():
    ...
    return render_template('library/label.html', label=label,
                           tracks=tracks)
...
@auth_manager.check_access('library')
def fixup():
    return render_template('library/fixup.html')
...
def fixup_tracks(key, page=1):
    ...
    return render_template('library/fixup_tracks.html', key=key,
...
def track(id):
    ...
    return render_template('library/track.html',
                           track=track,
                           edit_from=edit_from,
...
def track_musicbrainz(id):
    ...
    return render_template('library/track_musicbrainz.html',
                           track=track,
                           edit_from=edit_from,
...
def track_similar(id, page=1):
    ...
    return render_template('library/track_similar.html', track=track,
